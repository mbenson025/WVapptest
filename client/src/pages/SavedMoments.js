...
const SavedMoments = () => {
  ...
  // create function that accepts the moment's mongo _id value as param and deletes the moment from the database
  const handleDeleteMoment = async (momentId) => {
    ...
    try {
      ...
      // upon success, remove moment's id from localStorage
